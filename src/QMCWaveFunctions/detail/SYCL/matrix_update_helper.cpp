...
namespace qmcplusplus
{
  ...
  {
template<typename T>
sycl::event copyAinvRow_saveGL(sycl::queue& aq,
...
template sycl::event copyAinvRow_saveGL(sycl::queue& aq,
                                        const int rowchanged,
                                        const int n,
...
sycl::event calcGradients(sycl::queue& aq,
                          const int n,
...
template sycl::event calcGradients(sycl::queue& aq,
                                   const int n,
...
template sycl::event add_delay_list_save_sigma_VGL(sycl::queue& aq,
                                                   int* const delay_list[],
                                                   const int rowchanged,
                                                   const int delay_count,
                                                   float* const binv[],
